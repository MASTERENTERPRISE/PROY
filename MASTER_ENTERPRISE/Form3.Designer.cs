namespace MASTER_ENTERPRISE
{
    partial class Form3
    {
        ...
        private void InitializeComponent()
        {
            ...
            button1.TabIndex = 0;
            button1.Text = "LISTA DE PEDIDOS";
            button1.UseVisualStyleBackColor = true;
            button1.Click += button1_Click;
            // 
            // button2
            // 
            button2.Location = new Point(69, 153);
            button2.Name = "button2";
            button2.Size = new Size(167, 23);
            button2.TabIndex = 1;
            button2.Text = "LISTA DE TRABAJADORES";
            button2.UseVisualStyleBackColor = true;
            button2.Click += button2_Click;
            // 
            // button3
            // 
            button3.Location = new Point(69, 216);
            button3.Name = "button3";
            button3.Size = new Size(167, 23);
            button3.TabIndex = 2;
            button3.Text = "INGRESOS/EGRESOS";
            button3.UseVisualStyleBackColor = true;
            button3.Click += button3_Click;
            // 
            // button4
            // 
            button4.Location = new Point(69, 290);
